...
namespace ITIExaminationSyustem.Migrations
{
    ...
    [Migration("20240309151639_m11-UserRoleM2M")]
    partial class m11UserRoleM2M
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ITIExaminationSyustem.Models.Admin", b =>
                {
                    ...
                    b.Property<string>("Admin_User_Email")
                    ...
                    b.HasIndex("Admin_User_Email")
                        .IsUnique()
                        .HasFilter("[Admin_User_Email] IS NOT NULL");
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.Property<string>("Navigation_UsersUser_Email")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Navigation_RolesRole_Id", "Navigation_UsersUser_Email");

                    b.HasIndex("Navigation_UsersUser_Email");
            ...
            modelBuilder.Entity("ITIExaminationSyustem.Models.Admin", b =>
                {
                    ...
                    b.HasOne("ITIExaminationSyustem.Models.User", "Navigation_User")
                        .WithOne("Navigation_Admin")
                        .HasForeignKey("ITIExaminationSyustem.Models.Admin", "Admin_User_Email");
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("ITIExaminationSyustem.Models.User", null)
                        .WithMany()
                        .HasForeignKey("Navigation_UsersUser_Email")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
